...
export const RIDE_WEIGHT_SHIFT_MAX = 10;
export const RIDE_WEIGHT_RETURN_DURATION = 0.55;
export const RIDE_SPRING_STIFFNESS = 280;
export const RIDE_SPRING_DAMPING = 26;
export const RIDE_IMPACT_TO_DROP = 0.0065;
