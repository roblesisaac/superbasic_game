...
export const LUMEN_LOOP_ANGULAR_DECAY = 1.6;
export const LUMEN_LOOP_HELIUM_FLOAT_FORCE = 500;
export const LUMEN_LOOP_HELIUM_BLEED_RATE = 0.35;
export const LUMEN_LOOP_ENERGY_DRAIN_PER_ROTATION = 14;
export const LUMEN_LOOP_PEDAL_IMPULSE = 12;
export const LUMEN_LOOP_PEDAL_MOMENTUM_MAX = 6.5;
export const LUMEN_LOOP_ACTIVATION_ANGLE = Math.PI * 2;
